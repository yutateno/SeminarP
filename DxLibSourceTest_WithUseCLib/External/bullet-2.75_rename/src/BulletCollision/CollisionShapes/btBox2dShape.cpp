...
void D_btBox2dShape::getAabb(const D_btTransform& t,D_btVector3& aabbMin,D_btVector3& aabbMax) const
{
	D_btTransformAabb(getHalfExtentsWithoutMargin(),getMargin(),t,aabbMin,aabbMax);
}


void	D_btBox2dShape::calculateLocalInertia(D_btScalar mass,D_btVector3& inertia) const
{
