...
float D_btGImpactQuantizedBvh::getAverageTreeCollisionTime()
{
...
void D_btQuantizedBvhTree::calc_quantization(
	D_GIM_BVH_DATA_ARRAY & primitive_boxes, D_btScalar boundMargin)
{
	//calc globa box
	D_btAABB global_bound;
...
int D_btQuantizedBvhTree::_calc_splitting_axis(
...
int D_btQuantizedBvhTree::_sort_and_calc_splitting_index(
...
void D_btQuantizedBvhTree::_build_sub_tree(D_GIM_BVH_DATA_ARRAY & primitive_boxes, int startIndex,  int endIndex)
{
...
void D_btQuantizedBvhTree::build_tree(
...
void D_btGImpactQuantizedBvh::refit()
{
...
void D_btGImpactQuantizedBvh::buildSet()
{
...
bool D_btGImpactQuantizedBvh::boxQuery(const D_btAABB & box, D_btAlignedObjectArray<int> & collided_results) const
{
	int curIndex = 0;
...
//! returns the indices of the primitives in the m_primitive_manager
bool D_btGImpactQuantizedBvh::rayQuery(
...
D_SIMD_FORCE_INLINE bool _quantized_node_collision(
	D_btGImpactQuantizedBvh * boxset0, D_btGImpactQuantizedBvh * boxset1,
...
void D_btGImpactQuantizedBvh::find_collision(D_btGImpactQuantizedBvh * boxset0, const D_btTransform & trans0,
		D_btGImpactQuantizedBvh * boxset1, const D_btTransform & trans1,
		D_btPairSet & collision_pairs)
{
