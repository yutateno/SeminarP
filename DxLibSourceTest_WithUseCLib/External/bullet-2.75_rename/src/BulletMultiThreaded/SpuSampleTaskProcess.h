...
/// D_SpuSampleTaskProcess handles SPU processing of collision pairs.
...
public:
	D_SpuSampleTaskProcess(D_btThreadSupportInterface*	threadInterface, int maxNumOutstandingTasks);
	
	~D_SpuSampleTaskProcess();
