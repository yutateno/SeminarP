...
extern int Strcmp_Str2_WildcardT_( TCHAR   *Str1, TCHAR   *Str2 )
{
	...
	ConvString( ( const char * )Str1, _TCHARCODEFORMAT, ( char * )Str1W, sizeof( Str1W ), WCHAR_T_CHARCODEFORMAT ) ;
	ConvString( ( const char * )Str2, _TCHARCODEFORMAT, ( char * )Str2W, sizeof( Str2W ), WCHAR_T_CHARCODEFORMAT ) ;
...
extern	int			WriteOnlyFileAccessPrintf( DWORD_PTR Handle, const char *FormatString, ... )
{
	...
	for( i = 0 ; i < Length ; )
	{
		if( GetCharBytes_( ( char * )( &String[ i ] ), CHAR_CHARCODEFORMAT ) > sizeof( char ) )
		{
			i += 2 ;
		}
		else
