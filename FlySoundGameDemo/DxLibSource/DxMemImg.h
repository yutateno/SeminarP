...
extern	void 	DrawRotationMemImg(     MEMIMG *DestImg, const MEMIMG *SrcImg, int x, int y, float Angle, float EnlageRateX, float EnlageRateY,   int TransFlag = TRUE, int TurnFlag = FALSE, const MEMIMG *BlendImg = NULL ) ;		// イメージを回転描画する
