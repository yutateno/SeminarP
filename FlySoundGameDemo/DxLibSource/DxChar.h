...
extern	int				ConvString(				const char *Src, int SrcCharCodeFormat, char *Dest, size_t BufferBytes, int DestCharCodeFormat ) ;		// 文字列を指定の文字コード形式の文字列に変換する( 戻り値：変換後のサイズ、ヌル文字含む( 単位：バイト ) )
