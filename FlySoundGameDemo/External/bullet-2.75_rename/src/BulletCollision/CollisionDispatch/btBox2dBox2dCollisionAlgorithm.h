...
class D_btBox2dBox2dCollisionAlgorithm : public D_btActivatingCollisionAlgorithm
{
	bool	m_ownManifold;
	D_btPersistentManifold*	m_manifoldPtr;
	
public:
	D_btBox2dBox2dCollisionAlgorithm(const D_btCollisionAlgorithmConstructionInfo& ci)
	...
	D_btBox2dBox2dCollisionAlgorithm(D_btPersistentManifold* mf,const D_btCollisionAlgorithmConstructionInfo& ci,D_btCollisionObject* body0,D_btCollisionObject* body1);

	virtual ~D_btBox2dBox2dCollisionAlgorithm();
	...
	struct D_CreateFunc :public 	D_btCollisionAlgorithmCreateFunc
	{
		...
		{
			int bbsize = sizeof(D_btBox2dBox2dCollisionAlgorithm);
			void* ptr = ci.m_dispatcher1->allocateCollisionAlgorithm(bbsize);
			return new(ptr) D_btBox2dBox2dCollisionAlgorithm(0,ci,body0,body1);
		}
	};
