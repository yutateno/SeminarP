...
class D_SpuMinkowskiPenetrationDepthSolver : public D_btConvexPenetrationDepthSolver
{
public:
	D_SpuMinkowskiPenetrationDepthSolver() {}
	virtual ~D_SpuMinkowskiPenetrationDepthSolver() {};
